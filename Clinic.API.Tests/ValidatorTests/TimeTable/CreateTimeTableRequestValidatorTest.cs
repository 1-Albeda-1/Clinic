...
{
    public class CreateTimeTableRequestValidatorTest : ClinicContextInMemory
    {
        private readonly CreateTimeTableRequestValidator validator;

        public CreateTimeTableRequestValidatorTest()
        {
            validator = new CreateTimeTableRequestValidator(
        ...
        {
            //Arrange
            var model = new CreateTimeTableRequest
            {
